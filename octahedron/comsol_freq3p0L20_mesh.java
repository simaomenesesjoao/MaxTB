...
public class comsol_freq3p0L20_mesh {
  ...
  public static Model run() {
    ...
    model.modelPath("/data/users/sjoao/octahedron");

    model.label("octahedron.mph");
    ...
    model.result().export("data1").set("filename", "/home/sjoao/data/octahedron/pot_freq3p0L20_mesh.dat");
    model.result().export("data1").set("location", "file");
    model.result().export("data1").set("coordfilename", "/home/sjoao/data/octahedron/positions_mesh.dat");
