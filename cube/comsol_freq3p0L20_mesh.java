...
/** Model exported on Oct 7 2022, 18:43 by COMSOL 5.5.0.359. */
public class comsol_freq3p0L20_mesh {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("/data/users/sjoao/cube");

    model.label("cube.mph");
    ...
    model.component("comp1").material("mat1").propertyGroup("def")
         .set("relpermittivity", new String[]{"-0.8684000000000003+5.5440000000000005i", "0", "0", "0", "-0.8684000000000003+5.5440000000000005i", "0", "0", "0", "-0.8684000000000003+5.5440000000000005i"});
    ...
    model.result().export("data1").set("filename", "/home/sjoao/data/cube/pot_freq3p0L20_mesh.dat");
    model.result().export("data1").set("location", "file");
    model.result().export("data1").set("coordfilename", "/home/sjoao/data/cube/positions_mesh.dat");
