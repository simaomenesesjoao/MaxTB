...
public class comsol_freq2p4L20_mesh {
  ...
  public static Model run() {
    ...
    model.component("comp1").material("mat1").propertyGroup("def")
         .set("relpermittivity", new String[]{"-3.2096000000000005+1.86i", "0", "0", "0", "-3.2096000000000005+1.86i", "0", "0", "0", "-3.2096000000000005+1.86i"});
    ...
    model.result().export("data1").set("filename", "/home/sjoao/data/cube/pot_freq2p4L20_mesh.dat");
