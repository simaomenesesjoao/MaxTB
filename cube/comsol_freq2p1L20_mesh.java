...
public class comsol_freq2p1L20_mesh {
  ...
  public static Model run() {
    ...
    model.component("comp1").material("mat1").propertyGroup("def")
         .set("relpermittivity", new String[]{"-8.033199999999999+1.0224i", "0", "0", "0", "-8.033199999999999+1.0224i", "0", "0", "0", "-8.033199999999999+1.0224i"});
    ...
    model.result().export("data1").set("filename", "/home/sjoao/data/cube/pot_freq2p1L20_mesh.dat");
