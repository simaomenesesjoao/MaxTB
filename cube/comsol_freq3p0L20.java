...
public class comsol_freq3p0L20 {
  ...
  public static Model run() {
    ...
    model.result().export("data1").set("filename", "/home/sjoao/data/cube/pot_freq3p0L20_rad8.0.dat");
    model.result().export("data1").set("location", "file");
    model.result().export("data1").set("coordfilename", "/home/sjoao/data/cube/positions_rad8.0.dat");
