...
public class comsol_octa_freq3p0_mesh {
  ...
  public static Model run() {
    ...
    model.result().export("data1").set("filename", "/home/sjoao/octahedron/pot_freq3p0_mesh.dat");
    model.result().export("data1").set("location", "file");
    model.result().export("data1").set("coordfilename", "/home/sjoao/octahedron/positions_mesh.dat");
