...
public class rhombic {
  ...
  public static Model run() {
    ...
    model.component("comp1").material("mat1").propertyGroup("def")
         .set("relpermittivity", new String[]{"-3.2096+1.86i", "0", "0", "0", "-3.2096+1.86i", "0", "0", "0", "-3.2096+1.86i"});
    ...
    model.result().export("data1").set("filename", "/home/sjoao/rhombic/rhombic.txt");
    model.result().export("data1").set("location", "file");
    model.result().export("data1").set("coordfilename", "/home/sjoao/rhombic/positions_mesh.dat");
