...
public class comsol_freq3p0L20_mesh {
  ...
  public static Model run() {
    ...
    model.result().export("data1").set("filename", "/home/sjoao/data/rhombic/pot_freq3p0L20_mesh.dat");
    model.result().export("data1").set("location", "file");
    model.result().export("data1").set("coordfilename", "/home/sjoao/data/rhombic/positions_mesh.dat");
